...
void set_joint_position_plugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    ...
    ROS_INFO_STREAM("topicName:" << this->robot_namespace_ <<this->topic_name_);

    this->rosnode_ = new ros::NodeHandle(this->robot_namespace_);


    this->sub_ = this->rosnode_->subscribe( this->robot_namespace_ +this->topic_name_, 1, &set_joint_position_plugin::CallBackMethod, this, ros::TransportHints().tcpNoDelay() );
